 ...
 */
public class BarChartTouchListener extends BarLineChartTouchListener {
    ...
    private float mChartYValueRange;
     ...
     */
    public BarChartTouchListener(
            BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> chart,
    ...
    public boolean onDoubleTap(MotionEvent e) {
        ...
        mTouchingEntry = mChart.getData().getEntryForHighlight(h);
